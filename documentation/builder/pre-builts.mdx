...
5. Customize the Widgets:
    ...
    <Accordion title="Screenshots">
        <Frame>
        <img src="https://cdn.lightbooks-dev.io/docs/storefront/prebuilts/prebuilts-01.png" />
        </Frame>
        <Frame>
        <img src="https://cdn.lightbooks-dev.io/docs/storefront/prebuilts/prebuilts-02.png" />
        </Frame>
        <Frame>
        <img src="https://cdn.lightbooks-dev.io/docs/storefront/prebuilts/prebuilts-03.png" />
        </Frame>
        <Frame>
        <img src="https://cdn.lightbooks-dev.io/docs/storefront/prebuilts/prebuilts-04.png" />
        </Frame>
        <Frame>
        <img src="https://cdn.lightbooks-dev.io/docs/storefront/prebuilts/prebuilts-05.png" />
        </Frame>
        <Frame>
        <img src="https://cdn.lightbooks-dev.io/docs/storefront/prebuilts/prebuilts-06.png" />
        </Frame>
        <Frame>
        <img src="https://cdn.lightbooks-dev.io/docs/storefront/prebuilts/prebuilts-07.png" />
        </Frame>
        <Frame>
        <img src="https://cdn.lightbooks-dev.io/docs/storefront/prebuilts/prebuilts-08.png" />
        </Frame>
        <Frame>
        <img src="https://cdn.lightbooks-dev.io/docs/storefront/prebuilts/prebuilts-09.png" />
        </Frame>
    </Accordion>
...
4. Customize the Elements loaded onto the page:
    ...
    <Accordion title="Screenshots">
        <Frame>
        <img src="https://cdn.lightbooks-dev.io/docs/storefront/prebuilts/template-01.png" />
        </Frame>
        <Frame>
        <img src="https://cdn.lightbooks-dev.io/docs/storefront/prebuilts/template-02.png" />
        </Frame>
        <Frame>
        <img src="https://cdn.lightbooks-dev.io/docs/storefront/prebuilts/template-03.png" />
        </Frame>
        <Frame>
        <img src="https://cdn.lightbooks-dev.io/docs/storefront/prebuilts/template-04.png" />
        </Frame>
        <Frame>
        <img src="https://cdn.lightbooks-dev.io/docs/storefront/prebuilts/template-05.png" />
        </Frame>
        <Frame>
        <img src="https://cdn.lightbooks-dev.io/docs/storefront/prebuilts/template-06.png" />
        </Frame>
        <Frame>
        <img src="https://cdn.lightbooks-dev.io/docs/storefront/prebuilts/template-07.png" />
        </Frame>
    </Accordion>